...
abstract public class OperatorAst extends AstNode implements Calculable {
    ...
    public Enumeration GetOperands() {return GetChildren();}
    public int GetNumOperands() {return GetNumChildren();}
    public Calculable GetOperand(int i) {return (Calculable) GetChild(i);}
